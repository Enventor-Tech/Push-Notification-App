...
namespace PushNotifications.Services
{
    public class NotificationRegistrationService : INotificationRegistrationService
    {
        ...
        const string ScheduleUrl = "api/notifications/schedule"; 
        const string UpdateScheduleUrl = "api/notifications/schedule/update";
        string _baseApiUrl;
        HttpClient _client;
        ...
        public async Task ScheduleNotificationAsync(string message, int minutesBefore)
        {
            var cachedToken = await SecureStorage.GetAsync(CachedDeviceTokenKey)
                .ConfigureAwait(false);
        ...
        public async Task UpdateNotificationAsync(string message, int newMinutesBefore)
        {
            var cachedToken = await SecureStorage.GetAsync(CachedDeviceTokenKey)
                .ConfigureAwait(false);
            ...
            await SendAsync(HttpMethod.Put, UpdateScheduleUrl, request)
                .ConfigureAwait(false);
        }
